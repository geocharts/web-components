...
@customElement('geo-symbol-pack-map')
export class GeoSymbolPackMap extends BaseFrameMap {
  ...
  protected updateSVG(geoSymbolMapDataFrame: GeoMapDataFrame) {
...
declare global {
  interface HTMLElementTagNameMap {
    'geo-symbol-pack-map': GeoSymbolPackMap;
  }
}
