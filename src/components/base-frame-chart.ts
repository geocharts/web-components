...
// import {titleCss, infoCss, mapCss} from '../common/css';
...
//   static override styles = [titleCss, infoCss, mapCss];
...
//   override render() {
//     return html` <div style="width:100%; height:100%" id="geo-chart"></div> `;
//   }
